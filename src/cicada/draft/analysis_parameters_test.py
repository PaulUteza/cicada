...
class WidgetForParam(ABC):
    ...
    def __init__(self):
        ...
        self.keys_to_check = ['name', 'type']  # mandatory fields !
    ...
    def add_widget_to_layout(self, layout):
        if self.param['type'] != bool:
            if 'range' in self.param.keys():
                q_label = QLabel(self.param['name'] + " " + str(self.param['range']) + " :")
            else:
                q_label = QLabel(self.param['name'] + " :")
            q_label.setWindowFlags(Qt.FramelessWindowHint)
            q_label.setAttribute(Qt.WA_TranslucentBackground)
...
class ParamSection(QWidget):
    ...
    def create_widgets(self):
        ...
        all_params = InputParam().input_test
        ...
        label_param.setWindowFlags(Qt.FramelessWindowHint)
        label_param.setAttribute(Qt.WA_TranslucentBackground)
